...
class Trainer():
    ...
    def update_biases(self, layer_index, learning_rate = l_rate):
        self.model.layers[layer_index].b_ -= ((learning_rate) * self.optimizer.gradient_biases(layer_index))
    
    def update_weights(self, weight_index, learning_rate = l_rate):
        self.model.weights[weight_index].matrix -= ((learning_rate) * self.optimizer.gradient_weights(weight_index))
