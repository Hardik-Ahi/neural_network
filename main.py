...
from nn.dataset_utils import and_gate_dataset, linear_regression_dataset, standardize_data, equalize_classes, split_classes, split_data, pca
...
Plotter.plot_points(X_train[:, 0], X_train[:, 1])
v = pca(df, 'output')
Plotter.plot_points(v[:, 0], v[:, 1])
exit()
