...
from nn.dataset_utils import and_gate_dataset, linear_regression_dataset, standardize_data, equalize_classes, split_classes
...
print(df)
equalize_classes(df, 'output')
print(df)
test_df = split_classes(df, 'output', 0.5)
print(test_df)
print(df)